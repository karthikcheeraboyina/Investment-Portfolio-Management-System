...
public class PerformanceService {
    ...
    @Autowired
    public PerformanceService(AssetRepository assetRepository, PerformanceRepository performanceRepository) {
        this.assetRepository = assetRepository;
        this.performanceRepository = performanceRepository;
    }

    /**
     * Calculates and saves the performance of an asset based on its new current price.
     * @param assetId The ID of the asset to calculate performance for.
     * @param newCurrentPrice The latest market price per share/unit of the asset.
